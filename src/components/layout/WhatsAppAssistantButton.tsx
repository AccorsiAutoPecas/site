...
export function WhatsAppAssistantButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[max(0.5rem,env(safe-area-inset-bottom,0px))] right-2 z-[160] flex flex-col items-end transition hover:scale-[1.02] sm:bottom-[max(0.75rem,env(safe-area-inset-bottom,0px))] sm:right-4"
    ...
    >
      ...
      <span
        className="relative w-[5.9rem] overflow-hidden sm:hidden"
      ...
      <span className="hidden w-[11rem] flex-col items-end sm:flex">
        ...
        <span
          className="relative w-[11rem] overflow-hidden"
          style={{ aspectRatio: `${ASSISTENTE_FRAME_W} / ${ASSISTENTE_FRAME_H}` }}
        >
          <Image
            src="/icons/assistente.png"
